...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker
    .register("/ra-vn.github.io/app-worker.js")
    .then(reg => {
...
// Env
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/ra-vn.github.io","GOAPP_STATIC_RESOURCES_URL":"/ra-vn.github.io","GOAPP_VERSION":"b4c6ad72979b5e96ffbd80bfee3949a18f94058c"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/ra-vn.github.io/web/app.wasm"), go.importObject)
    .then(result => {
